 ...
 */
export function b2SetLengthUnitsPerMeter(lengthUnits: number): void;
/**
 ...
 */
export function b2GetLengthUnitsPerMeter(): number;
/**
 ...
 */
export function b2SetAssertFcn(assertFcn: Function | null): void;
/**
 ...
 */
export function b2GetVersion(): b2Version;
import { b2Version } from './include/base_h.js';
export const B2_NULL_INDEX: -1;
